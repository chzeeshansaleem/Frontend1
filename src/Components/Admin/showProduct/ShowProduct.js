...
const ShowProduct = () => {
  ...
  return (
    <>
      <h1
        id="ti"
        className="display-4 border border-5 rounded shadow p-3 mb-5 bg-body rounded-3 bg-info "
      >
        All product effortlessly with just a few clicks using our streamlined
        dashboard
      </h1>
      <h3>
        Total Products : <span style={{ color: "red" }}>{count}</span>
      </h3>
      <div className="container-fluid">
        {product.map((product) => (
          <div className="row mt-4 w-md-50" id="product">
            <div className="col-2 row text-danger  " id="shirt">
              <img
              ...
              <div className="row h-100  align-items-center justify-content-center">
                ...
                >
                  <button className="btn btn-info btn-block">
                    <i class="fa-solid fa-eye text-white" id="icon"></i>
                    <span id="shirt" className="text-white">
                      Preview
                    </span>
                  </button>
                </Link>

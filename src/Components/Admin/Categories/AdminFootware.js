...
import { remove, UpdateApi, Adminfootwares } from "../../Api/Apicall";
...
const AdminFootware = () => {
  ...
  const Productget = async () => {
    const response = await Adminfootwares();
  ...
  return (
    <>
      <h1 className="display-4 border border-5 rounded shadow p-3 mb-5 bg-body rounded-3 bg-info mt-5">
